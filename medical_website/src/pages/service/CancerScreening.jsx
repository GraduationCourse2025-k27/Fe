...
const CancerScreening = () => {
  ...
  const goiTamSoat = Goikham?.filter((item) => item.type === 'tam-soat');
    ...
    <div className='mt-5 pt-5'>
      ...
      <div className="flex flex-col md:flex-row items-center px-6">
        <div className="md:w-1/2 p-4">
          ...
          <p className="text-gray-700">
            Đa số bệnh nhân ung thư khi nhập viện đều ở giai đoạn muộn, gần như 70% - 80% bệnh nhân đã ở giai đoạn ung thư tiến xa. Việc phát hiện ở giai đoạn muộn làm cho việc điều trị không được hiệu quả và làm cho thời gian sống của người bệnh giảm đi.
            Tầm soát, phát hiện sớm ung thư là cách tốt nhất giúp phòng ngừa bệnh lý ung thư, tăng cơ hội điều trị thành công, tiết kiệm tối đa chi phí và bảo vệ sức khỏe của mỗi người.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4 my-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {goiTamSoat && goiTamSoat.length > 0 ? (
            goiTamSoat.map((item) => (
