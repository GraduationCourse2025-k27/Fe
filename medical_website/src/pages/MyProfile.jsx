      ...
      <div className="flex-grow flex items-center justify-center p-4 sm:p-5 mt-5">
        <div className="w-full max-w-md sm:max-w-xl bg-white border border-gray-200 rounded-lg p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 text-sm">
          ...
          {isEdit ? (
            ...
            <p className="font-medium text-2xl sm:text-3xl text-neutral-800 text-center">{userData.name}</p>
          )}
          <hr className="bg-zinc-400 h-[1px] border-none" />

          <div>
            <p className="text-neutral-500 underline text-base sm:text-lg">Thông tin cá nhân</p>
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_3fr] gap-y-2 sm:gap-y-3 mt-2 sm:mt-3 text-neutral-700 items-start sm:items-center">
              ...
              <p className="text-blue-900 text-xs sm:text-sm">{userData.email}</p>
              ...
              {isEdit ? (
                ...
                <p className="text-blue-900 text-xs sm:text-sm">{userData.phone}</p>
              )}
          ...
          <div>
            <p className="text-neutral-500 underline text-base sm:text-lg">Thông tin cơ bản</p>
            <div className="grid grid-cols-1 sm:grid-cols-[1fr_3fr] gap-y-2 sm:gap-y-3 mt-2 sm:mt-3 text-neutral-700 items-start sm:items-center">
