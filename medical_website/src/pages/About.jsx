...
const About = () => {
  ...
  return (
    ...
    {/* Header Section */}
    <div
      className="relative text-white py-26 bg-cover bg-center"
      style={{ backgroundImage: `url(${aboutBanner})` }}
    >
      <div className="absolute inset-0 "></div>
      <div className="relative">
      <h1 className="text-4xl font-bold ml-16">Về chúng tôi</h1>
      {!isMobile && (
          <p className="text-lg ml-16">
            Bệnh viện Đa khoa Đà Nẵng - Nơi chăm sóc sức khỏe toàn diện
          </p>
        )}
      </div>
    </div>
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm mt-2">Bác sĩ</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm mt-2">Bệnh nhân hài lòng</p>
        </div>
        {/* Số liệu: Giường bệnh */}
        <div className="flex flex-col items-center">
          <h3 className="text-3xl font-bold">
          ...
          <p className="text-sm mt-2">Giường bệnh</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm mt-2">Giải thưởng đạt được</p>
        </div>
      </div>
</div>
