...
const images = [
  ...
  "https://scontent.fdad3-6.fna.fbcdn.net/v/t39.30808-6/486460193_1175992537654037_3312515513579178960_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=127cfc&_nc_ohc=1lGXxa0STdwQ7kNvwFnSxOd&_nc_oc=Adkrhiqu9F_fEmNJ4b6EzM4hIYiHyw8sskO67VsLSeiYh9Q0iqCh0oYaTCVjs-0KGe0&_nc_zt=23&_nc_ht=scontent.fdad3-6.fna&_nc_gid=a4HA_P85bIcJMzEg27KUbg&oh=00_AYGga2JTmx4DKPu79Wirsb96A4qfSToP1KmZezy0cWlc_Q&oe=67F68C19",
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-4 md:gap-8 items-start">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-gray-700 mb-2 md:mb-2 text-sm md:text-base">
            Bệnh viện Đa khoa Đà Nẵng là cơ sở y tế hàng đầu tại miền Trung, với
            trang thiết bị hiện đại và đội ngũ y bác sĩ giàu kinh nghiệm. Bệnh
            viện cung cấp dịch vụ chăm sóc sức khỏe toàn diện, luôn nỗ lực nâng
            cao chất lượng để đáp ứng nhu cầu khám chữa bệnh của người dân.
          </p>
