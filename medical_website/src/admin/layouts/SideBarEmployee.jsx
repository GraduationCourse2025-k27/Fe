...
import { navbarLinksEmployee } from "../constants";

export const SideBarStaff = forwardRef(({ collapsed }, ref) => {
  ...
  return (
    <aside ref={ref} className={`${baseAsideClass} ${widthClass}`}>
      ...
      <div className="flex flex-col gap-y-5 px-2 pt-4 overflow-y-auto">
        {navbarLinksEmployee.map((navbarLink, index) => (
...
SideBarStaff.displayName = "SideBarStaff";
