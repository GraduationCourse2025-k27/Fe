...
const DoctorManagementPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h8 className="text-2xl font-bold">Quản lý bác sĩ</h8>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 text-left">Giá khám</th>
            ...
            {doctors.length > 0 ? (
              records.map((doc, index) => (
                <tr key={doc?.id} className="border-t">
                  ...
                  <td className="px-4 py-2">{doc?.client?.fullName}</td>
                  <td className="px-4 py-2">{doc?.speciality.name}</td>
