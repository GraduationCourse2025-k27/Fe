...
export const fetchAIResponse = async (messageHistory) => {
  ...
  const isMedicalTopic = (text) => {
    const medicalKeywords = [
      'bệnh', 'triệu chứng', 'khám', 'điều trị', 'thuốc', 'sức khỏe', 'bác sĩ', 'đau', 
      'viêm', 'nhiễm', 'dị ứng', 'nội khoa', 'ngoại khoa', 'y học', 'bị', 'chuyên khoa',
      'chẩn đoán', 'xét nghiệm', 'siêu âm', 'phẫu thuật', 'tiêm', 'vaccine', 'vắc xin',
      'huyết áp', 'tiểu đường', 'ung thư', 'gan', 'thận', 'phổi', 'tim', 'đường ruột',
      'da liễu', 'hô hấp', 'tiêu hóa', 'đột quỵ', 'chăm sóc', 'theo dõi', 'dịch bệnh', 
      'vi khuẩn', 'virus', 'lây nhiễm', 'kháng sinh', 'tư vấn y tế', 'tái khám', 'mạch', 
      'sốt', 'ho', 'suy nhược', 'chóng mặt', 'buồn nôn', 'khám bệnh', 'bác sĩ chuyên khoa',
      'cấp cứu', 'hồi sức', 'nhi khoa', 'sản khoa', 'phụ khoa', 'nam khoa', 'xương khớp',
      'thần kinh', 'tâm thần', 'rối loạn', 'khám định kỳ', 'hồ sơ bệnh án', 'hội chẩn'
    ];

    const greetingKeywords = ['hello', 'hi', 'xin chào', 'chào bạn', 'chào', 'hey', 'alo'];
